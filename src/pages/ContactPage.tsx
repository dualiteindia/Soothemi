      ...
      <SectionReveal>
        <section className="w-full px-4 md:px-10 pt-6 pb-20">
          <div className="relative w-full min-h-[700px] rounded-[2.5rem] overflow-hidden shadow-soft flex items-center">
            ...
            <img 
              src="https://www.dropbox.com/scl/fi/a0yf1boldmiuzdoohpcbt/freepik__upload__91632.png?rlkey=vaz5qdlz9zq21w3e2awm60lgr&st=x5f7ipky&raw=1" 
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center h-full py-12">
              ...
              <div className="text-white">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="font-serif text-lg text-white tracking-wide">+872 198 192 8313</span>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="font-serif text-lg text-white tracking-wide">hello@soothemi.yoga</span>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="font-serif text-lg text-white tracking-wide">@soothemi</span>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full max-w-lg ml-auto">
                <div className="bg-white rounded-[1.5rem] p-8 md:p-10 shadow-lg">
                  <h2 className="font-serif text-3xl text-soothe-text mb-8">Send us a message</h2>
                  
                  <form className="flex flex-col gap-5">
                    {/* Full Name */}
                    <div className="flex flex-col gap-2">
                      <label htmlFor="name" className="font-sans text-sm text-soothe-text font-medium">Full Name</label>
                      <input 
                        type="text" 
                        id="name" 
                    ...
                    {/* Email Address */}
                    <div className="flex flex-col gap-2">
                      <label htmlFor="email" className="font-sans text-sm text-soothe-text font-medium">Email Address</label>
                      <input 
                        type="email" 
                        id="email" 
                    ...
                    {/* Services Dropdown */}
                    <div className="flex flex-col gap-2">
                      <label htmlFor="service" className="font-sans text-sm text-soothe-text font-medium">Services</label>
                    ...
                    {/* Message */}
                    <div className="flex flex-col gap-2">
                      <label htmlFor="message" className="font-sans text-sm text-soothe-text font-medium">Message</label>
                      <textarea 
                        id="message" 
                        rows={4}
